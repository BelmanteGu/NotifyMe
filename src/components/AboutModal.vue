    ...
    >
      ...
      >
        <header class="flex items-center justify-between px-6 py-5 border-b border-border/40">
          <h2 id="about-title" class="text-lg font-bold tracking-tight">Sobre o NotifyMe</h2>
          <button
            @click="close"
        ...
        <div class="px-6 py-6">
          ...
          <div class="space-y-2 mb-6">
            ...
            >
              ...
              <span class="flex-1 font-medium">Código no GitHub</span>
          ...
          <div class="rounded-md bg-accent p-5 mb-3">
            ...
            <div class="grid grid-cols-2 gap-2">
              <button
                ...
                class="btn-primary px-4 py-2.5 rounded-xl text-primary-foreground text-xs font-semibold"
              >
                Ko-fi
              </button>
              <button
                @click="openLink(sponsorsUrl)"
                class="px-4 py-2.5 rounded-xl border border-border bg-card hover:bg-muted text-xs font-semibold transition"
              >
                GitHub Sponsors
              </button>
            </div>
