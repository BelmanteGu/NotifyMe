...
Aba "Notas" da janela main com um board interno onde o usuário cria,
arrasta e edita post-its coloridos. Cada nota tem cor, texto editável,
posição e rotação base aleatória pra parecer natural. Veja
[14-sticky-notes.md](14-sticky-notes.md).
